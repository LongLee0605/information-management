// scripts/verify-database.js — Đối chiếu SQL Server ↔ API ↔ FE mapping
...
async function main() {
  ...
  try {
    ...
    if (sampleCustomerId) {
      ...
      const pie = await fetchJson(
        `/api/reports/pie-chart?customerId=${sampleCustomerId}&transactionType=debit&fromDate=2025-01-01&toDate=2025-12-31`,
      );
