...
export function SourceAccountSelect({ accounts, value, onChange, }: SourceAccountSelectProps) {
    ...
    return (<div>
      ...
      <Select id="source-account" value={value} onChange={onChange} options={options} aria-label="Tài khoản chuyển"/>
