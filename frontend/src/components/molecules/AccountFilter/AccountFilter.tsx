...
export function AccountFilter({
  ...
  function updateField<K extends keyof AccountFilterValues>(
    key: K,
    ...
    <div className={cn('border-b border-border px-6 py-4', className)}>
      <div className="flex flex-wrap items-center gap-3">
        ...
        <Select
          ...
          onChange={(value) => updateField('accountType', value as AccountFilterValues['accountType'])}
          options={[
        ...
        <Select
          value={values.status}
          onChange={(value) => updateField('status', value as AccountFilterValues['status'])}
          options={[
          ...
          aria-label="Tình trạng tài khoản"
        ...
        {onClear && (
          <Button variant="secondary" type="button" className="shrink-0" onClick={onClear}>
            Xóa bộ lọc
          </Button>
        )}
      </div>
