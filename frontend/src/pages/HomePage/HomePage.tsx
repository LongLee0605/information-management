...
export default function HomePage() {
  ...
  const filteredUsers = useMemo(
    () => filterCustomers(users, appliedFilters),
  ...
  return (
    <div className="page-stack">
      ...
      {deleteError && (
        <p className="fixed bottom-6 right-6 rounded-lg border border-red-200 bg-white px-4 py-3 text-sm text-red-600 shadow-lg">
          {deleteError}
        </p>
      )}
    </div>
